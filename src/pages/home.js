    ...
    <section class="hero">
      ...
      <div class="hero__content">
        ...
        <h1 class="hero__title" data-reveal data-delay="0.2">
          <span class="hero__line">Hi, I'm <em>Eva Good</em></span>
          <span class="hero__line hero__line--accent">I design experiences</span>
          <span class="hero__line">people <span class="hero__underline">love</span>.</span>
        </h1>

        <p class="hero__sub" data-reveal data-delay="0.4">
          Product designer crafting intuitive, beautiful digital experiences
          that bridge the gap between human needs and business goals.
        </p>
    ...
    <section class="section featured">
      <div class="container">
        <div class="section__header" data-reveal>
          ...
          <h2 class="section__title">Projects I'm proud of</h2>
        </div>

        <div class="featured__grid">
          <div class="project-card tilt-card" data-reveal data-delay="0.1">
            <div class="project-card__image" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%)">
          ...
          <div class="project-card tilt-card" data-reveal data-delay="0.25">
            <div class="project-card__image" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%)">
              <div class="project-card__mockup">
          ...
          <div class="project-card project-card--wide tilt-card" data-reveal data-delay="0.15">
            <div class="project-card__image" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)">
              <div class="project-card__mockup">
    ...
    <section class="section philosophy">
      <div class="container">
        <div class="philosophy__content">
          <span class="section__label" data-reveal>My Approach</span>
          <blockquote class="philosophy__quote" data-reveal data-delay="0.15">
            <p>Great design doesn't just look beautiful&mdash;it <em>feels</em> inevitable. I obsess over the moments between clicks, the micro-interactions that make people smile, and the systems that scale gracefully.</p>
          </blockquote>
          ...
          <div class="philosophy__pillars">
            <div class="pillar" data-reveal data-delay="0.2">
              ...
              <h3 class="pillar__title">Research-Led</h3>
            ...
            <div class="pillar" data-reveal data-delay="0.3">
              ...
              <h3 class="pillar__title">Systems Thinking</h3>
            ...
            <div class="pillar" data-reveal data-delay="0.4">
              ...
              <h3 class="pillar__title">Craft & Detail</h3>
    ...
    <section class="section cta-section">
      <div class="container">
        <div class="cta-banner" data-reveal>
          ...
          <p class="cta-banner__sub">I'd love to hear about it. Let's create something extraordinary together.</p>
